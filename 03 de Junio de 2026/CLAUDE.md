...
- Bitácoras se guardan en `Bitacoras/` con consecutivo (`GestorUrbano_Bitacora_vXX_0.md` + `.docx`) — próxima: v53.0 (v52.0 creada 25-sep-2026). La rama `BITACORA_v3.x.md` quedó obsoleta y fue movida a `_OBSOLETO/`.
