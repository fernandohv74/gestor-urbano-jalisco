...
| Name | What |
|------|------|
| **Gestor Urbano Jalisco AMG** | Plataforma de 23 módulos para consulta de uso de suelo, licencias y trámites en los 5 municipios del AMG. HTML standalone sin frameworks. Módulo 01 (uso de suelo) completo para GDL, calibrando Zapopan. Ver `memory/projects/gestor-urbano-jalisco-amg.md` para detalle de módulos y fases. |
...
- Bitácoras se guardan en `Bitacoras/` con consecutivo (`GestorUrbano_Bitacora_vXX_0.md` + `.docx`) — próxima: v31.0 (v30.0 pendiente de crear). La rama `BITACORA_v3.x.md` quedó obsoleta y fue movida a `_OBSOLETO/`.
